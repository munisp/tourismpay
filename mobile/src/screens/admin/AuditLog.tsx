...
export function AuditLog({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      <Text style={s.title}>Audit Log</Text>
      {/* Stats */}
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Today</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>This Week</Text></View>
      ...
      <View style={s.emptyState}>
        ...
        <Text style={s.emptySubtext}>System audit events will appear here</Text>
      </View>
