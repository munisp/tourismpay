/**
 * KYBApplications — KYB Applications
 */
import React from "react";
import { View, Text, ScrollView, TouchableOpacity, StyleSheet } from "react-native";

export function KYBApplications({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      <Text style={s.title}>KYB Applications</Text>
      {/* Stats */}
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Pending</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Approved</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Rejected</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Applications</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>📋</Text>
        <Text style={s.emptyText}>No applications</Text>
        <Text style={s.emptySubtext}>KYB applications will appear here for review</Text>
      </View>
