...
export default function TourismIntelligenceScreen({ navigation }: any) {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      setError(null);
      const result = await apiRequest("/admin/tourismintelligence");
      setData(result);
    } catch (e: any) {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>TourismIntelligence</Text>
      </View>
