/**
 * J09 — Tourism Intelligence (Mobile)
 */
...
export default function TourismIntelligenceReportScreen({ navigation }: any) {
  ...
  const handleSubmit = async () => {
    try {
      setLoading(true);
      const res = await request<any>("journeyV2.startTourismIntelligenceReport", {
        method: "POST",
        body: fields,
      });
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>J09 — Tourism Intelligence</Text>
