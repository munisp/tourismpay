  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.statsRow}>
        ...
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Expiring</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Missing</Text></View>
      </View>
      {/* Content */}
      ...
      <View style={s.emptyState}>
        ...
        <Text style={s.emptySubtext}>Uploaded merchant documents will appear here</Text>
      </View>
