...
const TourismIntelligenceScreen: React.FC = () => {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <View style={[styles.iconBadge, { backgroundColor: '#4F46E520' }]}>
          <Text style={[styles.iconText, { color: '#4F46E5' }]}>⬡</Text>
        </View>
        <View style={styles.headerText}>
          <Text style={styles.title}>Tourism Intelligence</Text>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Tourism Intelligence Dashboard</Text>
        {error ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>Tourism Intelligence</Text>
            ...
            <TouchableOpacity
              ...
              onPress={loadData}
            >
              <Text style={styles.buttonText}>Load Tourism Intelligence Data</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
...
export default TourismIntelligenceScreen;
