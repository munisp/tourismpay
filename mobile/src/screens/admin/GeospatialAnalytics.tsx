...
export default function GeospatialAnalyticsScreen({ navigation }: any) {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      setError(null);
      const result = await apiRequest("/admin/geospatialanalytics");
      setData(result);
    } catch (e: any) {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>GeospatialAnalytics</Text>
      </View>
