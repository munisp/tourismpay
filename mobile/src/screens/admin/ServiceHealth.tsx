...
export function ServiceHealth({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      <Text style={s.title}>Service Health</Text>
      {/* Stats */}
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>API</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Database</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Go</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Python</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Service Status</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>💚</Text>
        <Text style={s.emptyText}>All systems go</Text>
        <Text style={s.emptySubtext}>Service health monitoring dashboard</Text>
      </View>
