  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>USD/NGN</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>USD/KES</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>USD/ZAR</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Active Corridors</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>💱</Text>
        <Text style={s.emptyText}>Loading rates...</Text>
        <Text style={s.emptySubtext}>Live exchange rates for all supported currency pairs</Text>
      </View>
