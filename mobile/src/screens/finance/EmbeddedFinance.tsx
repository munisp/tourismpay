...
export function EmbeddedFinance({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      <Text style={s.title}>Embedded Finance</Text>
      {/* Stats */}
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Credit Line</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Insurance</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Savings</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Financial Products</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>🏦</Text>
        <Text style={s.emptyText}>Coming soon</Text>
        <Text style={s.emptySubtext}>Embedded financial services for tourism businesses</Text>
      </View>
