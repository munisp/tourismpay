  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>AML Score</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>SARs Filed</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Status</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Compliance Status</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>📜</Text>
        <Text style={s.emptyText}>Compliant</Text>
        <Text style={s.emptySubtext}>Regulatory compliance monitoring and reporting</Text>
      </View>
