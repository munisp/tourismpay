  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Sessions</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Conversions</Text></View>
        <View style={s.stat}><Text style={s.statNum}>$0</Text><Text style={s.statLabel}>GMV</Text></View>
      </View>
      {/* Content */}
      ...
      <View style={s.emptyState}>
        ...
        <Text style={s.emptySubtext}>Platform analytics will populate as activity increases</Text>
      </View>
