  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>0 kg</Text><Text style={s.statLabel}>CO2 Offset</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Credits</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Badge</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Carbon Credits</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>🌱</Text>
        <Text style={s.emptyText}>Go green</Text>
        <Text style={s.emptySubtext}>Offset your travel carbon footprint with verified African projects</Text>
      </View>
