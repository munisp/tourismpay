/**
 * MerchantStripeConnect — Stripe Connect
 */
import React from "react";
import { View, Text, ScrollView, TouchableOpacity, StyleSheet } from "react-native";

export function MerchantStripeConnect({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.statsRow}>
        ...
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Balance</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Payouts</Text></View>
      </View>
      {/* Actions */}
      <View style={s.actionsGrid}>
        <TouchableOpacity style={s.actionBtn}><Text style={s.actionEmoji}>🔗</Text><Text style={s.actionLabel}>Connect</Text></TouchableOpacity>
        <TouchableOpacity style={s.actionBtn}><Text style={s.actionEmoji}>📊</Text><Text style={s.actionLabel}>Dashboard</Text></TouchableOpacity>
      ...
      {/* Content */}
      <Text style={s.section}>Connection Status</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>💳</Text>
        <Text style={s.emptyText}>Not connected</Text>
        <Text style={s.emptySubtext}>Connect your Stripe account to accept payments and receive payouts</Text>
      </View>
