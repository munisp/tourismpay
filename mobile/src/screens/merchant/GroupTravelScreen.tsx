...
const GroupTravelScreen: React.FC = () => {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          <Text style={styles.title}>Group Travel & MICE</Text>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Group Travel & MICE Dashboard</Text>
        {error ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>Group Travel & MICE</Text>
            ...
            <TouchableOpacity
              ...
              onPress={loadData}
            >
              <Text style={styles.buttonText}>Load Group Travel & MICE Data</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
