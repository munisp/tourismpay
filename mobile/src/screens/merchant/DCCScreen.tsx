  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <View style={[styles.iconBadge, { backgroundColor: '#14B8A620' }]}>
          <Text style={[styles.iconText, { color: '#14B8A6' }]}>⬡</Text>
        </View>
        <View style={styles.headerText}>
          <Text style={styles.title}>Dynamic Currency</Text>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Dynamic Currency Dashboard</Text>
        {error ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>Dynamic Currency</Text>
            ...
            <TouchableOpacity
              ...
              onPress={loadData}
            >
              <Text style={styles.buttonText}>Load Dynamic Currency Data</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
