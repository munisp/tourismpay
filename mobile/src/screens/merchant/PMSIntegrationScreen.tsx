...
const PMSIntegrationScreen: React.FC = () => {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          <Text style={styles.title}>PMS Integration</Text>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>PMS Integration Dashboard</Text>
        {error ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>PMS Integration</Text>
            ...
            <TouchableOpacity
              ...
              onPress={loadData}
            >
              <Text style={styles.buttonText}>Load PMS Integration Data</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
...
export default PMSIntegrationScreen;
