...
export function MerchantBISStatus({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      <Text style={s.title}>BIS Status</Text>
      {/* Stats */}
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Status</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Score</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Last Check</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Background Check</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>🔍</Text>
        <Text style={s.emptyText}>Pending review</Text>
        <Text style={s.emptySubtext}>Your background investigation status will be shown here</Text>
      </View>
