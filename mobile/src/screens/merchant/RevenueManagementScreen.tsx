...
const RevenueManagementScreen: React.FC = () => {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <View style={[styles.iconBadge, { backgroundColor: '#05966920' }]}>
          <Text style={[styles.iconText, { color: '#059669' }]}>⬡</Text>
        </View>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Revenue Management Dashboard</Text>
        {error ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>Revenue Management</Text>
            ...
            <TouchableOpacity
              ...
              onPress={loadData}
            >
              <Text style={styles.buttonText}>Load Revenue Management Data</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
