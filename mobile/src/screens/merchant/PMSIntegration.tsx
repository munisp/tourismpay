...
export default function PMSIntegrationScreen({ navigation }: any) {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      setError(null);
      const result = await apiRequest("/merchant/pmsintegration");
      setData(result);
    } catch (e: any) {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>PMSIntegration</Text>
      </View>
