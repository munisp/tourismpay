/**
 * J16 — Group Travel Cancellation (Mobile)
 */
...
export default function GroupTravelCancellationScreen({ navigation }: any) {
  ...
  const handleSubmit = async () => {
    try {
      setLoading(true);
      const res = await request<any>("journeyV2.startGroupCancellation", {
        method: "POST",
        body: fields,
      });
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>J16 — Group Travel Cancellation</Text>
