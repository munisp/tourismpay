  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>Buy Now Pay Later Dashboard</Text>
        {error ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>Buy Now Pay Later</Text>
            ...
            <TouchableOpacity
              ...
              onPress={loadData}
            >
              <Text style={styles.buttonText}>Load Buy Now Pay Later Data</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
