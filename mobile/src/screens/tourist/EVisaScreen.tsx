    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        ...
        <View style={styles.headerText}>
          <Text style={styles.title}>e-Visa Payment</Text>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>e-Visa Payment Dashboard</Text>
        {error ? (
          <Text style={styles.errorText}>{error}</Text>
        ) : loading ? (
          <ActivityIndicator size="large" color="#EF4444" style={{ marginVertical: 32 }} />
        ) : data ? (
          <Text style={styles.dataText}>{JSON.stringify(data, null, 2).slice(0, 200)}...</Text>
        ) : (
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>e-Visa Payment</Text>
            ...
            <TouchableOpacity
              ...
              onPress={loadData}
            >
              <Text style={styles.buttonText}>Load e-Visa Payment Data</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
