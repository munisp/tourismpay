...
export default function TravelInsuranceScreen({ navigation }: any) {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      setError(null);
      const result = await apiRequest("/tourist/travelinsurance");
      setData(result);
    } catch (e: any) {
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>TravelInsurance</Text>
      </View>
