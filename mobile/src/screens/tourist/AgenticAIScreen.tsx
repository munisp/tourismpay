...
const AgenticAIScreen: React.FC = () => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        <View style={[styles.iconBadge, { backgroundColor: '#7C3AED20' }]}>
          <Text style={[styles.iconText, { color: '#7C3AED' }]}>⬡</Text>
        </View>
        <View style={styles.headerText}>
          <Text style={styles.title}>AI Travel Agent</Text>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>AI Travel Agent Dashboard</Text>
        {error ? (
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyTitle}>AI Travel Agent</Text>
            ...
            <TouchableOpacity
              ...
              onPress={loadData}
            >
              <Text style={styles.buttonText}>Load AI Travel Agent Data</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
