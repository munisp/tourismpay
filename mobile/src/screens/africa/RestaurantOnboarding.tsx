/**
 * RestaurantOnboarding — Merchant Setup Wizard
 */
...
export function RestaurantOnboarding({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      <Text style={s.title}>Merchant Setup Wizard</Text>
      {/* Stats */}
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>0%</Text><Text style={s.statLabel}>Progress</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Type</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Country</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Setup Progress</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>🏨</Text>
        <Text style={s.emptyText}>Get started</Text>
        <Text style={s.emptySubtext}>Complete your establishment profile to start accepting tourists</Text>
      </View>
