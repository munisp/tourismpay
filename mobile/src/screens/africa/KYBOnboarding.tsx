/**
 * KYBOnboarding — KYB Verification
 */
...
export function KYBOnboarding({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      <Text style={s.title}>KYB Verification</Text>
      {/* Stats */}
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Status</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0/5</Text><Text style={s.statLabel}>Steps</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Documents</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Verification Steps</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>📋</Text>
        <Text style={s.emptyText}>Start KYB</Text>
        <Text style={s.emptySubtext}>Complete Know Your Business verification to accept payments</Text>
      </View>
