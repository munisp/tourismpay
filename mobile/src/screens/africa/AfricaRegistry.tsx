/**
 * AfricaRegistry — Africa Tourism Registry
 */
import React from "react";
import { View, Text, ScrollView, TouchableOpacity, StyleSheet } from "react-native";

export function AfricaRegistry({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      <Text style={s.title}>Africa Tourism Registry</Text>
      {/* Stats */}
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>12</Text><Text style={s.statLabel}>Countries</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Establishments</Text></View>
        <View style={s.stat}><Text style={s.statNum}>18</Text><Text style={s.statLabel}>Categories</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Registered Establishments</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>🌍</Text>
        <Text style={s.emptyText}>Explore Africa</Text>
        <Text style={s.emptySubtext}>Browse and register tourism establishments across the continent</Text>
      </View>
