/**
 * TwoFactorSettings — Two-Factor Auth
 */
...
export function TwoFactorSettings({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      ...
      {/* Content */}
      <Text style={s.section}>2FA Status</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>🔑</Text>
        <Text style={s.emptyText}>Not enabled</Text>
        <Text style={s.emptySubtext}>Enable two-factor authentication for enhanced security</Text>
      </View>
