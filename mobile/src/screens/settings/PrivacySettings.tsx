  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.actionsGrid}>
        <TouchableOpacity style={s.actionBtn}><Text style={s.actionEmoji}>📥</Text><Text style={s.actionLabel}>Export Data</Text></TouchableOpacity>
        <TouchableOpacity style={s.actionBtn}><Text style={s.actionEmoji}>🗑️</Text><Text style={s.actionLabel}>Delete Data</Text></TouchableOpacity>
        <TouchableOpacity style={s.actionBtn}><Text style={s.actionEmoji}>📋</Text><Text style={s.actionLabel}>Consent</Text></TouchableOpacity>
      </View>
      {/* Content */}
      <Text style={s.section}>Data Privacy</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>🔐</Text>
        <Text style={s.emptyText}>Your data is safe</Text>
        <Text style={s.emptySubtext}>GDPR/POPIA compliant data management</Text>
      </View>
