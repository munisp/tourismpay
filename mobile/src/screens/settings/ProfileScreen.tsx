  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.actionsGrid}>
        <TouchableOpacity style={s.actionBtn}><Text style={s.actionEmoji}>📸</Text><Text style={s.actionLabel}>Photo</Text></TouchableOpacity>
        <TouchableOpacity style={s.actionBtn}><Text style={s.actionEmoji}>✏️</Text><Text style={s.actionLabel}>Edit</Text></TouchableOpacity>
        <TouchableOpacity style={s.actionBtn}><Text style={s.actionEmoji}>🔑</Text><Text style={s.actionLabel}>Password</Text></TouchableOpacity>
      </View>
