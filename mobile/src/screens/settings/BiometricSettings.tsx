...
export function BiometricSettings({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      ...
      {/* Content */}
      <Text style={s.section}>Biometric Options</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>👆</Text>
        <Text style={s.emptyText}>Configure biometrics</Text>
        <Text style={s.emptySubtext}>Set up Face ID or fingerprint for quick login</Text>
      </View>
