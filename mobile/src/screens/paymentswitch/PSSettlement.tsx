/**
 * PSSettlement — Settlement Console
 */
  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.statsRow}>
        ...
        <View style={s.stat}><Text style={s.statNum}>$0</Text><Text style={s.statLabel}>Processing</Text></View>
        <View style={s.stat}><Text style={s.statNum}>$0</Text><Text style={s.statLabel}>Settled</Text></View>
      </View>
      {/* Content */}
      ...
      <View style={s.emptyState}>
        ...
        <Text style={s.emptySubtext}>Settlement batches will appear here as they process</Text>
      </View>
