  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.statsRow}>
        ...
        <View style={s.stat}><Text style={s.statNum}>$0</Text><Text style={s.statLabel}>In-Flight</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Completed</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Transfers</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>💸</Text>
        <Text style={s.emptyText}>No remittances</Text>
        <Text style={s.emptySubtext}>Cross-border remittance transfers will appear here</Text>
      </View>
