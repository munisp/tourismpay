...
export function SOCDashboard({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      <Text style={s.title}>SOC Dashboard</Text>
      {/* Stats */}
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Incidents</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>MTTD</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>MTTR</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Open</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Security Events</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>🔒</Text>
        <Text style={s.emptyText}>Secure</Text>
        <Text style={s.emptySubtext}>Security operations center — no active threats</Text>
      </View>
