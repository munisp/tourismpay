  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.actionsGrid}>
        <TouchableOpacity style={s.actionBtn}><Text style={s.actionEmoji}>🛡️</Text><Text style={s.actionLabel}>Fraud</Text></TouchableOpacity>
        <TouchableOpacity style={s.actionBtn}><Text style={s.actionEmoji}>🔒</Text><Text style={s.actionLabel}>SOC</Text></TouchableOpacity>
        ...
        <TouchableOpacity style={s.actionBtn}><Text style={s.actionEmoji}>📱</Text><Text style={s.actionLabel}>Devices</Text></TouchableOpacity>
