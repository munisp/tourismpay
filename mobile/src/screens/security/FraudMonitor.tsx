...
export function FraudMonitor({ navigation }: any) {
  return (
    <ScrollView style={s.container}>
      <Text style={s.title}>Fraud Monitor</Text>
      {/* Stats */}
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Alerts</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0</Text><Text style={s.statLabel}>Blocked</Text></View>
        <View style={s.stat}><Text style={s.statNum}>0%</Text><Text style={s.statLabel}>False Positive</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Risk Score</Text></View>
      </View>
      {/* Content */}
      ...
      <View style={s.emptyState}>
        ...
        <Text style={s.emptySubtext}>No fraud alerts detected. System monitoring active.</Text>
      </View>
