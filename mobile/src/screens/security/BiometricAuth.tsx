  ...
  return (
    <ScrollView style={s.container}>
      ...
      <View style={s.statsRow}>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Face ID</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Fingerprint</Text></View>
        <View style={s.stat}><Text style={s.statNum}>—</Text><Text style={s.statLabel}>Liveness</Text></View>
      </View>
      {/* Content */}
      <Text style={s.section}>Auth Methods</Text>
      <View style={s.emptyState}>
        <Text style={s.emptyEmoji}>👆</Text>
        <Text style={s.emptyText}>Set up biometrics</Text>
        <Text style={s.emptySubtext}>Enable face or fingerprint authentication for secure access</Text>
      </View>
