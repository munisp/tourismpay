...
const LivenessDetectionScreen: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      setError(null);
      const response = await apiClient.get('/kyc/liveness');
      setData(response);
    } catch (err) {
  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Loading Liveness Verification...</Text>
      </View>
    );
  }
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Camera-based liveness detection for KYC verification</Text>
      </View>
