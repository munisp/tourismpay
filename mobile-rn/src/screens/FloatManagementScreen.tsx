...
const FloatManagementScreen: React.FC = () => {
  ...
  const loadData = async () => {
    try {
      setError(null);
      const response = await apiClient.get('/float/balance');
      setData(response);
    } catch (err) {
  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Loading Float Management...</Text>
      </View>
    );
  }
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>View and manage agent float balance, top-ups, and history</Text>
      </View>
...
export default FloatManagementScreen;
