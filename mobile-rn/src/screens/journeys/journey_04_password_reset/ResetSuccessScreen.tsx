...
export const ResetSuccessScreen: React.FC<ResetSuccessScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Reset Success</Text>
      <Text style={styles.subtitle}>Cash In</Text>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#34C759', padding: 16, borderRadius: 14, alignItems: 'center', marginTop: 24 },
