...
interface BeneficiarySelectionScreenProps {
  navigation: any;
  route: any;
}

export const BeneficiarySelectionScreen: React.FC<BeneficiarySelectionScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Beneficiary Selection</Text>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#5856D6', padding: 16, borderRadius: 14, alignItems: 'center', marginTop: 24 },
