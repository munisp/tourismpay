...
interface SelectBillerScreenProps {
  navigation: any;
  route: any;
}

export const SelectBillerScreen: React.FC<SelectBillerScreenProps> = ({ navigation, route }) => {
  ...
  const handleContinue = async () => {
    ...
    try {
    navigation.navigate('BillDetails', { ...route.params });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Select Biller</Text>
