...
export const BillPaymentSuccessScreen: React.FC<BillPaymentSuccessScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Bill Payment Success</Text>
      <Text style={styles.subtitle}>Bill Payment</Text>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#FF9500', padding: 16, borderRadius: 14, alignItems: 'center', marginTop: 24 },
