...
interface InternationalSendScreenProps {
  navigation: any;
  route: any;
}

export const InternationalSendScreen: React.FC<InternationalSendScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>International Send</Text>
