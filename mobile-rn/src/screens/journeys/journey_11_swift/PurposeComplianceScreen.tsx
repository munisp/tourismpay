...
interface PurposeComplianceScreenProps {
  navigation: any;
  route: any;
}

export const PurposeComplianceScreen: React.FC<PurposeComplianceScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Purpose Compliance</Text>
