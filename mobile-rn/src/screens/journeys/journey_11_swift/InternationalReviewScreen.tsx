...
interface InternationalReviewScreenProps {
  navigation: any;
  route: any;
}

export const InternationalReviewScreen: React.FC<InternationalReviewScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>International Review</Text>
      <Text style={styles.subtitle}>NFC Payment</Text>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#5AC8FA', padding: 16, borderRadius: 14, alignItems: 'center', marginTop: 24 },
