...
interface WiseConfirmScreenProps {
  navigation: any;
  route: any;
}

export const WiseConfirmScreen: React.FC<WiseConfirmScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Wise Confirm</Text>
