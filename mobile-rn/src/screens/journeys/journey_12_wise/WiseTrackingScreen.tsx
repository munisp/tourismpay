...
interface WiseTrackingScreenProps {
  navigation: any;
  route: any;
}

export const WiseTrackingScreen: React.FC<WiseTrackingScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Wise Tracking</Text>
