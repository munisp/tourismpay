/**
 * BeneficiarySavedScreen
 * Journey: Agent Profile
 * ID: journey_18
 */
...
interface BeneficiarySavedScreenProps {
  navigation: any;
  route: any;
}

export const BeneficiarySavedScreen: React.FC<BeneficiarySavedScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Beneficiary Saved</Text>
      <Text style={styles.subtitle}>Agent Profile</Text>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#0066FF', padding: 16, borderRadius: 14, alignItems: 'center', marginTop: 24 },
