...
interface BeneficiaryFormScreenProps {
  navigation: any;
  route: any;
}

export const BeneficiaryFormScreen: React.FC<BeneficiaryFormScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Beneficiary Form</Text>
