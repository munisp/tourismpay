/**
 * RequestVirtualAccountScreen
 * Journey: Dispute / Reversal
 * ID: journey_17
 */
...
interface RequestVirtualAccountScreenProps {
  navigation: any;
  route: any;
}

export const RequestVirtualAccountScreen: React.FC<RequestVirtualAccountScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Request Virtual Account</Text>
      <Text style={styles.subtitle}>Dispute / Reversal</Text>
