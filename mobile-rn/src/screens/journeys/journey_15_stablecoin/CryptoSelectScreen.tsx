...
interface CryptoSelectScreenProps {
  navigation: any;
  route: any;
}

export const CryptoSelectScreen: React.FC<CryptoSelectScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Crypto Select</Text>
