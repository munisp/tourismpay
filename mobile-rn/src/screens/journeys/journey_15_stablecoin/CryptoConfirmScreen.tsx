...
interface CryptoConfirmScreenProps {
  navigation: any;
  route: any;
}

export const CryptoConfirmScreen: React.FC<CryptoConfirmScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Crypto Confirm</Text>
