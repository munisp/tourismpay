...
interface CryptoTrackingScreenProps {
  navigation: any;
  route: any;
}

export const CryptoTrackingScreen: React.FC<CryptoTrackingScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Crypto Tracking</Text>
      <Text style={styles.subtitle}>Loyalty Rewards</Text>
