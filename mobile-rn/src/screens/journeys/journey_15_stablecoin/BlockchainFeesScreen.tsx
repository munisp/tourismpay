...
interface BlockchainFeesScreenProps {
  navigation: any;
  route: any;
}

export const BlockchainFeesScreen: React.FC<BlockchainFeesScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Blockchain Fees</Text>
