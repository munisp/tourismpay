...
interface InsuranceProductsScreenProps {
  navigation: any;
  route: any;
}

export const InsuranceProductsScreen: React.FC<InsuranceProductsScreenProps> = ({ navigation, route }) => {
