...
interface SuspiciousActivityScreenProps {
  navigation: any;
  route: any;
}

export const SuspiciousActivityScreen: React.FC<SuspiciousActivityScreenProps> = ({ navigation, route }) => {
