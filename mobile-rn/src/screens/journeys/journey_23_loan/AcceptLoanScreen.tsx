...
interface AcceptLoanScreenProps {
  navigation: any;
  route: any;
}

export const AcceptLoanScreen: React.FC<AcceptLoanScreenProps> = ({ navigation, route }) => {
  ...
  const handleContinue = async () => {
    ...
    try {
    navigation.navigate('Disbursement', { ...route.params });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Accept Loan</Text>
