...
interface CreditScoringScreenProps {
  navigation: any;
  route: any;
}

export const CreditScoringScreen: React.FC<CreditScoringScreenProps> = ({ navigation, route }) => {
  ...
  const handleContinue = async () => {
    ...
    try {
    navigation.navigate('LoanOffer', { ...route.params });
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Credit Scoring</Text>
      <Text style={styles.subtitle}>Nano Loan</Text>
