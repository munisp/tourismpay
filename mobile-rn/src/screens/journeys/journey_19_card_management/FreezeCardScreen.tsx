...
interface FreezeCardScreenProps {
  navigation: any;
  route: any;
}

export const FreezeCardScreen: React.FC<FreezeCardScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.subtitle}>Terminal Settings</Text>
