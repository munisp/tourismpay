...
interface ScheduleConfirmationScreenProps {
  navigation: any;
  route: any;
}

export const ScheduleConfirmationScreen: React.FC<ScheduleConfirmationScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Schedule Confirmation</Text>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#007AFF', padding: 16, borderRadius: 14, alignItems: 'center', marginTop: 24 },
