...
interface SocialLoginOptionsScreenProps {
  navigation: any;
  route: any;
}

export const SocialLoginOptionsScreen: React.FC<SocialLoginOptionsScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Social Login Options</Text>
      <Text style={styles.subtitle}>Cash Out</Text>
