...
interface TierOverviewScreenProps {
  navigation: any;
  route: any;
}

export const TierOverviewScreen: React.FC<TierOverviewScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Tier Overview</Text>
