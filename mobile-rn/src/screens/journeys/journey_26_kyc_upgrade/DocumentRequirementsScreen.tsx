...
interface DocumentRequirementsScreenProps {
  navigation: any;
  route: any;
}

export const DocumentRequirementsScreen: React.FC<DocumentRequirementsScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Document Requirements</Text>
