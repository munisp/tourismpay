...
interface IncidentDetectionScreenProps {
  navigation: any;
  route: any;
}

export const IncidentDetectionScreen: React.FC<IncidentDetectionScreenProps> = ({ navigation, route }) => {
