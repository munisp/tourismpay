...
interface IncidentInvestigationScreenProps {
  navigation: any;
  route: any;
}

export const IncidentInvestigationScreen: React.FC<IncidentInvestigationScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Incident Investigation</Text>
