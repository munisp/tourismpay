...
interface GoalCreatedScreenProps {
  navigation: any;
  route: any;
}

export const GoalCreatedScreen: React.FC<GoalCreatedScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Goal Created</Text>
