...
interface AutoSaveSetupScreenProps {
  navigation: any;
  route: any;
}

export const AutoSaveSetupScreen: React.FC<AutoSaveSetupScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Auto Save Setup</Text>
