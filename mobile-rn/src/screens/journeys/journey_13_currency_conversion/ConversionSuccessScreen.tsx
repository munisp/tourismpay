...
interface ConversionSuccessScreenProps {
  navigation: any;
  route: any;
}

export const ConversionSuccessScreen: React.FC<ConversionSuccessScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Conversion Success</Text>
      <Text style={styles.subtitle}>Float Withdrawal</Text>
