...
interface ConversionPreviewScreenProps {
  navigation: any;
  route: any;
}

export const ConversionPreviewScreen: React.FC<ConversionPreviewScreenProps> = ({ navigation, route }) => {
