/**
 * BankInstructionsScreen
 * Journey: Transaction History
 * ID: journey_16
 */
...
interface BankInstructionsScreenProps {
  navigation: any;
  route: any;
}

export const BankInstructionsScreen: React.FC<BankInstructionsScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Bank Instructions</Text>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#636366', padding: 16, borderRadius: 14, alignItems: 'center', marginTop: 24 },
