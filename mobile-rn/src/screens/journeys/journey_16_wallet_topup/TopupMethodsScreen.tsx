...
interface TopupMethodsScreenProps {
  navigation: any;
  route: any;
}

export const TopupMethodsScreen: React.FC<TopupMethodsScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Topup Methods</Text>
