...
interface TopupAmountScreenProps {
  navigation: any;
  route: any;
}

export const TopupAmountScreen: React.FC<TopupAmountScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Topup Amount</Text>
