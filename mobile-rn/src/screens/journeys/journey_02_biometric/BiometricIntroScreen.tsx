...
interface BiometricIntroScreenProps {
  navigation: any;
  route: any;
}

export const BiometricIntroScreen: React.FC<BiometricIntroScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Biometric Intro</Text>
