...
interface PAPSSConfirmScreenProps {
  navigation: any;
  route: any;
}

export const PAPSSConfirmScreen: React.FC<PAPSSConfirmScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>P A P S S Confirm</Text>
