...
interface PAPSSDestinationScreenProps {
  navigation: any;
  route: any;
}

export const PAPSSDestinationScreen: React.FC<PAPSSDestinationScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>P A P S S Destination</Text>
