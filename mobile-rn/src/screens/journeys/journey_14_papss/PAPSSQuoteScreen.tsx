...
interface PAPSSQuoteScreenProps {
  navigation: any;
  route: any;
}

export const PAPSSQuoteScreen: React.FC<PAPSSQuoteScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>P A P S S Quote</Text>
