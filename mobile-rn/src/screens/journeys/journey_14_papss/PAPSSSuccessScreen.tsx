...
interface PAPSSSuccessScreenProps {
  navigation: any;
  route: any;
}

export const PAPSSSuccessScreen: React.FC<PAPSSSuccessScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>P A P S S Success</Text>
      <Text style={styles.subtitle}>Commission Payout</Text>
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#AF52DE', padding: 16, borderRadius: 14, alignItems: 'center', marginTop: 24 },
