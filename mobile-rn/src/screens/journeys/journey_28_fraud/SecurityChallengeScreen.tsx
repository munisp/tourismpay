...
interface SecurityChallengeScreenProps {
  navigation: any;
  route: any;
}

export const SecurityChallengeScreen: React.FC<SecurityChallengeScreenProps> = ({ navigation, route }) => {
  ...
  const handleContinue = async () => {
    ...
    try {
    navigation.navigate('FraudResolution', { ...route.params });
    } finally {
      setIsLoading(false);
    }
  };
