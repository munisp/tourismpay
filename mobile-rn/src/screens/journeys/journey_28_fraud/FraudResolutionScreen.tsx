/**
 * FraudResolutionScreen
 * Journey: Fraud & Security
 * ID: journey_28
 */
...
interface FraudResolutionScreenProps {
  navigation: any;
  route: any;
}

export const FraudResolutionScreen: React.FC<FraudResolutionScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Fraud Resolution</Text>
      <Text style={styles.subtitle}>Fraud & Security</Text>
      ...
      <TouchableOpacity
        ...
        disabled={isLoading}
      >
        <Text style={styles.buttonText}>{isLoading ? 'Processing...' : 'Done'}</Text>
      </TouchableOpacity>
    </ScrollView>
  );
};
...
const styles = StyleSheet.create({
  ...
  primaryButton: { backgroundColor: '#FF3B30', padding: 16, borderRadius: 14, alignItems: 'center', marginTop: 24 },
