...
interface InvestmentConfirmScreenProps {
  navigation: any;
  route: any;
}

export const InvestmentConfirmScreen: React.FC<InvestmentConfirmScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Investment Confirm</Text>
