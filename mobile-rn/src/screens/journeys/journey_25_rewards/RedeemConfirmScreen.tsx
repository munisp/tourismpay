...
interface RedeemConfirmScreenProps {
  navigation: any;
  route: any;
}

export const RedeemConfirmScreen: React.FC<RedeemConfirmScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Redeem Confirm</Text>
