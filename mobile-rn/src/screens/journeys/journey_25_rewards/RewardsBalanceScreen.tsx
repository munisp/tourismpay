...
interface RewardsBalanceScreenProps {
  navigation: any;
  route: any;
}

export const RewardsBalanceScreen: React.FC<RewardsBalanceScreenProps> = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.title}>Rewards Balance</Text>
