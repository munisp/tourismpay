# TourismPay Agency Banking Platform — Production Readiness Report
...
| Customer SMS Confirmation             | Termii SMS on Cash Out, Transfer, Card/QR/NFC                     | ✅           |
...
| Category         | Screens                                                                            |
| ---------------- | ---------------------------------------------------------------------------------- |
| Transactions (8) | Cash In, Cash Out, Transfer, Card Payment, QR Payment, NFC Payment, Airtime, Bills |
