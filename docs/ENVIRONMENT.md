...
## TourismPay Agency Banking Platform
...
| `KEYCLOAK_REALM`         | Yes      | `tourismpay`                 | Keycloak realm name                    |
...
| `SES_SMTP_FROM`          | No       | `noreply@tourismpay.ng`      | Default sender email                   |
...
| `S3_BUCKET`              | No       | `tourismpay-uploads`         | S3 bucket name                         |
| `FIDO2_RP_ID`            | No       | `tourismpay.ng`              | WebAuthn relying party ID              |
| `FIDO2_RP_NAME`          | No       | `TourismPay POS`             | WebAuthn relying party name            |
| `FIDO2_ORIGIN`           | No       | `https://tourismpay.ng`      | WebAuthn origin                        |
