...
export async function generateCompliancePdfBuffer(
  ...
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .fontSize(22)
      .font("Helvetica-Bold")
      .text("TourismPay POS — Weekly Security Compliance Report", 50, 22, {
    ...
    doc
      ...
      .font("Helvetica")
      .text(
        "This report is auto-generated by the TourismPay POS compliance engine. Retain for a minimum of 7 years per CBN guidelines.",
        50,
        doc.y,
