// Sprint 87: Upgraded from mock data to real DB queries — agentTerritoryHeatmap
import { z } from "zod";
...
const getTerritoryStats = protectedProcedure
  .input(
    z.object({
      page: z.number().optional(),
      limit: z.number().optional(),
...
const getAgentLocations = protectedProcedure
  .input(
    z.object({
      page: z.number().optional(),
      limit: z.number().optional(),
...
const getOptimalCoverage = protectedProcedure
  .input(
    z.object({
      page: z.number().optional(),
      limit: z.number().optional(),
