...
export function validateEnvironment(): ValidationResult {
  ...
  const HARDCODED_PATTERNS = [
    "postourismpay-secret",
    "postourismpay-dev-secret",
    "tourismpay-dev",
    "tourismpay-platform-dev",
    "tourismpay-service-token-dev",
    "tourismpay-keycloak-dev",
    "tourismpay_minio_dev",
    "tourismpay-apisix-dev",
    "tourismpay-fluvio-dev",
    "tourismpay_mqtt_dev",
    "TLtest_tourismpay",
    "tourismpay_admin",
    "change-in-prod",
