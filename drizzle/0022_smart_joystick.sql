CREATE TABLE "sim_orchestrator_config" (
	...
	"relayEndpoint" varchar(256) DEFAULT 'https://api.54link.io/api/trpc/simOrchestrator.ingestProbe' NOT NULL,
	"apiKey" varchar(128) DEFAULT '54link-sim-orchestrator-default-key' NOT NULL,
