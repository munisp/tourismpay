...
export default function PaymentDisputeArbitration() {
  const {
    ...
    isLoading,
    refetch,
  } = trpc.paymentDisputeArbitration.getStats.useQuery();
    ...
    <DashboardLayout>
      <div className="p-6 space-y-6 min-h-screen bg-gray-950 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">Dispute Arbitration</h1>
            <p className="text-gray-400 text-sm mt-1">
              Multi-party payment dispute resolution and arbitration workflow
            </p>
          </div>
