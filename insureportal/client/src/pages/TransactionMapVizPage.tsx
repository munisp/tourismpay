...
export default function TransactionMapVizPage() {
  const [search, setSearch] = useState("");
  const [activeTab, setActiveTab] = useState("overview");
  const statsQuery = trpc.transactionMapViz.getStats.useQuery();
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Real-time map visualization of transaction locations
            </p>
          </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Transaction Map Dashboard</CardTitle>
                <CardDescription>
          ...
          <TabsContent value="settings">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Configure Transaction Map settings and preferences.
                  </p>
                  <Button
                    variant="outline"
