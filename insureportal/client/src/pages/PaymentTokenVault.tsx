    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              PCI-DSS compliant tokenization for recurring payments
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Payment Token Vault Records</CardTitle>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-2">Scheme</th>
                    ...
                    .map((item: any) => (
                      ...
                      >
                        <td className="py-3 px-2">
                          <div className="font-medium">{item.maskedPan}</div>
                          <div className="text-xs text-muted-foreground">
                            {item.id}
                          </div>
                        </td>
                        <td className="py-3 px-2">{item.scheme}</td>
                        <td className="py-3 px-2">{item.tokenType}</td>
                        <td className="py-3 px-2">{item.usageCount} txns</td>
                        <td className="py-3 px-2">
                          <Badge
                            variant={
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                >
                  {action.isPending ? "Processing..." : "Create Token"}
                </Button>
                <Button
                  className="w-full"
                  variant="outline"
