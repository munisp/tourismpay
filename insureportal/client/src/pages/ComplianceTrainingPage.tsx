...
export default function ComplianceTrainingPage() {
  ...
  const statsQuery = trpc.complianceTrainingTracker.getStats.useQuery();
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Agent certification tracking and renewal management
            </p>
          </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Compliance Training Dashboard</CardTitle>
                <CardDescription>
          ...
          <TabsContent value="settings">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Configure Compliance Training settings and preferences.
                  </p>
                  <Button
                    variant="outline"
