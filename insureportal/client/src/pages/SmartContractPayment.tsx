...
export default function SmartContractPayment() {
  ...
  const stats = trpc.smartContractPayment.getStats.useQuery();
  const list = trpc.smartContractPayment.listContracts.useQuery();
  const action = trpc.smartContractPayment.deployContract.useMutation({
    onSuccess: () => toast.success("Deploy Contract completed successfully"),
    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Blockchain-based settlement and escrow management
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Smart Contract Payments Records</CardTitle>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-2">TVL</th>
                  ...
                  {(list.data?.contracts ?? [])
                    ...
                    .map((item: any) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-2">{item.network}</td>
                        <td className="py-3 px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                >
                  {action.isPending ? "Processing..." : "Deploy Contract"}
                </Button>
                <Button
                  className="w-full"
                  variant="outline"
