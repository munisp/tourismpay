...
export default function DisputeMediationAI() {
  const [search, setSearch] = useState("");
  const stats = trpc.disputeMediationAI.getStats.useQuery();

  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">AI Dispute Mediation</h1>
