...
export default function AgentLoanOrigination() {
  const {
    ...
    isLoading,
    refetch,
  } = trpc.agentLoanOrigination.getStats.useQuery();
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              Micro-loan application, credit scoring, and approval workflow for
              agents
            </p>
          </div>
        ...
        {isLoading ? (
          ...
          <>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                <p className="text-xs text-gray-400 mb-1">Avg Credit Score</p>
                <p className="text-xl font-bold text-orange-400">
                  {String(stats?.avgCreditScore ?? "—")}
                </p>
              </div>
            </div>
