...
export default function TransactionVelocityMonitor() {
    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">Transaction Velocity Monitor</h1>
            <p className="text-muted-foreground">
              Manage and monitor transaction velocity monitor operations
            </p>
          </div>
