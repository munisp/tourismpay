...
export default function TransactionReversalManager() {
  const {
    data: stats,
    isLoading,
    refetch,
  } = trpc.transactionReversalManager.getStats.useQuery();
    ...
    <DashboardLayout>
      <div className="p-6 space-y-6 min-h-screen bg-gray-950 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">Reversal Manager</h1>
            <p className="text-gray-400 text-sm mt-1">
              Automated and manual transaction reversal workflows with approval
              chains
            </p>
          </div>
