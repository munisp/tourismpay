...
export default function TransactionReconciliationPage() {
  ...
  const statsQuery = trpc.transactionReconciliation.getStats.useQuery();
      ...
      <div className="space-y-6 p-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Transaction Reconciliation Dashboard</CardTitle>
                <CardDescription>
          ...
          <TabsContent value="settings">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Configure Transaction Reconciliation settings and
                    preferences.
                  </p>
                  <Button
                    variant="outline"
