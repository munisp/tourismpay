...
CREATE TYPE "public"."tx_type" AS ENUM('Premium Payment', 'Claim Payout', 'Transfer', 'Card Payment', 'QR Payment', 'NFC Payment', 'Airtime', 'Bill Payment', 'Reversal', 'Nano Loan', 'Insurance');--> statement-breakpoint
CREATE TABLE "agents" (
