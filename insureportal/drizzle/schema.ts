...
export const mqttBridgeConfig = pgTable(
  "mqtt_bridge_config",
  {
    ...
    brokerUrl: text("brokerUrl")
      .notNull()
      .default("mqtt://broker.insureportal.ng:1883"),
...
export const simOrchestratorConfig = pgTable(
  "sim_orchestrator_config",
  {
    ...
    relayEndpoint: varchar("relayEndpoint", { length: 256 })
      .notNull()
      .default("https://api.insureportal.ng/api/trpc/simOrchestrator.ingestProbe"),
...
export const transactionLimits = pgTable(
  "transaction_limits",
  {
    ...
    txType: text("tx_type").notNull(), // premium_payment, claim_payout, transfer, bills, airtime
