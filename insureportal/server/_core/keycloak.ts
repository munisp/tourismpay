 ...
 *  - KEYCLOAK_URL          e.g. https://auth.insureportal.ng
 *  - KEYCLOAK_REALM        e.g. insureportal
 *  - KEYCLOAK_CLIENT_ID    e.g. insureportal
...
function getConfig(): KeycloakConfig {
  ...
  const clientId = process.env.KEYCLOAK_CLIENT_ID ?? "insureportal";
  const clientSecret =
    process.env.KEYCLOAK_CLIENT_SECRET ??
    "insureportal-secret-change-in-production";
