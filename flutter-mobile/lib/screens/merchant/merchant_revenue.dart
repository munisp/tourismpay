...
class _MerchantRevenueState extends State<MerchantRevenue> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      await _offlineDb.cacheData('merchantrevenue_list', {'items': _items}, ttlSeconds: 300);
    } catch (e) {
      final cached = await _offlineDb.getCachedData('merchantrevenue_list');
      if (cached != null) {
          ...
          Padding(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: 'Search revenue analytics...',
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text('No revenue analytics found', style: Theme.of(context).textTheme.bodyLarge),
                        ],
                      ),
                    )
                  : RefreshIndicator(
