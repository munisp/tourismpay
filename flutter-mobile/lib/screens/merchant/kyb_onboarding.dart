...
class KybOnboarding extends StatefulWidget {
  const KybOnboarding({super.key});

  @override
  State<KybOnboarding> createState() => _KybOnboardingState();
}

class _KybOnboardingState extends State<KybOnboarding> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      await _offlineDb.cacheData('kybonboarding_list', {'items': _items}, ttlSeconds: 300);
    } catch (e) {
      final cached = await _offlineDb.getCachedData('kybonboarding_list');
      if (cached != null) {
          ...
          Padding(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: 'Search kyb verification...',
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text('No kyb verification found', style: Theme.of(context).textTheme.bodyLarge),
                        ],
                      ),
                    )
                  : RefreshIndicator(
