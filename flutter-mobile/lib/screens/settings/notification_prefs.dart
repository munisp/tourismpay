...
class _NotificationPrefsScreenState extends State<NotificationPrefsScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      await _offlineDb.cacheData('notificationprefs_list', {'items': _items}, ttlSeconds: 300);
    } catch (e) {
      final cached = await _offlineDb.getCachedData('notificationprefs_list');
      if (cached != null) {
                ...
                : _items.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Icon(Icons.notifications, size: 64, color: Colors.grey.shade300),
                          const SizedBox(height: 16),
