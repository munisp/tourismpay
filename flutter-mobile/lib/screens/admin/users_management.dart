...
class _UsersManagementState extends State<UsersManagement> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      await _offlineDb.cacheData('usersmanagement_list', {'items': _items}, ttlSeconds: 300);
    } catch (e) {
      final cached = await _offlineDb.getCachedData('usersmanagement_list');
      if (cached != null) {
          ...
          Padding(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: 'Search users management...',
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          Text('No users management found', style: Theme.of(context).textTheme.bodyLarge),
                        ],
                      ),
                    )
                  : RefreshIndicator(
