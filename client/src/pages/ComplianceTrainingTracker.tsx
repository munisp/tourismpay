...
export default function ComplianceTrainingTracker() {
  const {
    ...
    isLoading,
    refetch,
  } = trpc.complianceTrainingTracker.getStats.useQuery();
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              Mandatory training completion tracking and certification
              management
            </p>
          </div>
          ...
          <>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                <p className="text-xs text-gray-400 mb-1">Total Trainings</p>
              ...
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                <p className="text-xs text-gray-400 mb-1">Active Certs</p>
                <p className="text-xl font-bold text-indigo-400">
                  {String(stats?.certificatesActive ?? "—")}
                </p>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
