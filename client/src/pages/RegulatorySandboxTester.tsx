    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Test new financial products under CBN guidelines
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Regulatory Sandbox Records</CardTitle>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    <th className="text-left py-3 px-2">Sandbox</th>
                  ...
                  {(list.data?.sandboxes ?? [])
                    ...
                    .map((item: any) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-2">{item.participants}</td>
                        <td className="py-3 px-2">{item.complianceScore}%</td>
                        <td className="py-3 px-2">
                          <Badge
                            variant={
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                >
                  {action.isPending ? "Processing..." : "Run Compliance Check"}
                </Button>
                <Button
                  className="w-full"
                  variant="outline"
