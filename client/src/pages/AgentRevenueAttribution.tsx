    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Multi-touch attribution model for agent revenue tracking
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Revenue Attribution Records</CardTitle>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-2">Direct</th>
                  ...
                  {(list.data?.attributions ?? [])
                    ...
                    .map((item: any) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-2">
                          ₦{item.directRevenue?.toLocaleString()}
                        </td>
                        <td className="py-3 px-2">
                          ₦{item.referralRevenue?.toLocaleString()}
                        </td>
                        <td className="py-3 px-2">
                          ₦{item.networkRevenue?.toLocaleString()}
                        </td>
                        <td className="py-3 px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                >
                  {action.isPending ? "Processing..." : "Recalculate"}
                </Button>
                <Button
                  className="w-full"
                  variant="outline"
