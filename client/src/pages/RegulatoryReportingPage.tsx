...
export default function RegulatoryReportingPage() {
  ...
  const statsQuery = trpc.regulatoryReportingEngine.getStats.useQuery();
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              CBN, NIBSS, NFIU regulatory report generation and submission
            </p>
          </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Regulatory Reporting Dashboard</CardTitle>
                <CardDescription>
          ...
          <TabsContent value="settings">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Configure Regulatory Reporting settings and preferences.
                  </p>
                  <Button
                    variant="outline"
