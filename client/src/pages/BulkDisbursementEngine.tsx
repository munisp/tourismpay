...
export default function BulkDisbursementEngine() {
  const {
    ...
    isLoading,
    refetch,
  } = trpc.bulkDisbursementEngine.getStats.useQuery();
    ...
    <DashboardLayout>
      <div className="p-6 space-y-6 min-h-screen bg-gray-950 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">Bulk Disbursement</h1>
            <p className="text-gray-400 text-sm mt-1">
              Mass payment processing for agent commissions, bonuses, and
              settlements
            </p>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                ...
                <p className="text-xl font-bold text-amber-400">
                  {String(stats?.processingBatches ?? "—")}
                </p>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
              ...
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                ...
                <p className="text-xl font-bold text-purple-400">
                  {String(stats?.totalRecipients ?? "—")}
                </p>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                <p className="text-xs text-gray-400 mb-1">Failure Rate %</p>
                <p className="text-xl font-bold text-cyan-400">
                  {String(stats?.failureRate ?? "—")}
                </p>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
