...
export default function CustomerWalletSystem() {
  const [search, setSearch] = useState("");
  const stats = trpc.customerWalletSystem.getStats.useQuery();
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Digital wallet management with top-up and transfers
          </p>
        </div>
