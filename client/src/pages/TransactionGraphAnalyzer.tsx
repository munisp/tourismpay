    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Graph-based transaction analysis for AML/CFT compliance
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Transaction Graph Records</CardTitle>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-2">Nodes</th>
                  ...
                  {(list.data?.clusters ?? [])
                    ...
                    .map((item: any) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-2">{item.riskScore}</td>
                        <td className="py-3 px-2">
                          <Badge
                            variant={item.flagged ? "outline" : "secondary"}
                          >
                            {item.status || "—"}
                          </Badge>
                        </td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                >
                  {action.isPending ? "Processing..." : "Analyze Transaction"}
                </Button>
                <Button
                  className="w-full"
                  variant="outline"
