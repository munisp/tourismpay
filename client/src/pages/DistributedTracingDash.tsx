...
export default function DistributedTracingDash() {
  const stats = trpc.distributedTracingDash.getStats.useQuery();
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage and monitor traces</p>
        </div>
        <button
      ...
      {stats.isLoading ? (
        ...
        <>
          ...
          <div className="bg-card border border-border rounded-lg p-6">
            <h2 className="text-lg font-semibold mb-4">Traces Overview</h2>
