...
export default function PlatformCapacityPlanner() {
  ...
  const action = trpc.platformCapacityPlanner.runProjection.useMutation({
    onSuccess: () => toast.success("Run Projection completed successfully"),
    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Infrastructure capacity planning with growth projections
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Capacity Planner Records</CardTitle>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-2">Growth Rate</th>
                    <th className="text-left py-3 px-2">Exhaustion</th>
                  ...
                  {(list.data?.resources ?? [])
                    ...
                    .map((item: any) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-2">{item.currentUsage}%</td>
                        <td className="py-3 px-2">{item.growthRate}%/mo</td>
                        <td className="py-3 px-2">{item.exhaustionDate}</td>
                        <td className="py-3 px-2">
                          <Badge
                            variant={
                              item.status === "healthy"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                >
                  {action.isPending ? "Processing..." : "Run Projection"}
                </Button>
                <Button
                  className="w-full"
                  variant="outline"
