/**
 * TourismPay Platform — Privacy Policy & NDPR Compliance Page
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-6 py-8">
        ...
        >
          <div className="text-sm font-bold text-white mb-1">
            TourismPay Financial Services Limited — Privacy Policy
          </div>
          <div className="text-xs text-gray-400">
            This document governs the collection, use, and protection of
            personal data on the TourismPay Platform. It is compliant
        ...
        <div className="mt-8 text-center text-xs text-gray-500 pb-8">
          © 2026 TourismPay Financial Services Limited. All rights reserved.
          <br />
