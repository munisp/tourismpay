        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              End-to-end customer account opening with KYC pipeline tracking
            </p>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                ...
                <p className="text-xl font-bold text-purple-400">
                  {String(stats?.conversionRate ?? "—")}
                </p>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                <p className="text-xs text-gray-400 mb-1">Tier 1</p>
                <p className="text-xl font-bold text-cyan-400">
                  {String(stats?.tier1Count ?? "—")}
                </p>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                <p className="text-xs text-gray-400 mb-1">Tier 2</p>
                <p className="text-xl font-bold text-indigo-400">
                  {String(stats?.tier2Count ?? "—")}
                </p>
              </div>
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                <p className="text-xs text-gray-400 mb-1">Tier 3</p>
                <p className="text-xl font-bold text-orange-400">
                  {String(stats?.tier3Count ?? "—")}
                </p>
              </div>
            </div>
