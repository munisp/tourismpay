...
export default function PlatformHealthDash() {
  ...
  const { data: _liveData } = trpc.platformHealthDash.list.useQuery(undefined, {
    retry: 1,
  });
    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">Platform Health Dash</h1>
            <p className="text-muted-foreground">
              Manage and monitor platform health dash operations
            </p>
          </div>
