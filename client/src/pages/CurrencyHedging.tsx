    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">Currency Hedging</h1>
            <p className="text-muted-foreground">
              Real-time FX hedging for multi-currency float positions
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Currency Hedging Records</CardTitle>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-2">Notional</th>
                      ...
                      >
                        <td className="py-3 px-2">
                          <div className="font-medium">
                            {item.hedge} ({item.direction})
                          </div>
                          <div className="text-xs text-muted-foreground">
                            {item.id}
                          </div>
                        </td>
                        <td className="py-3 px-2">{item.pair}</td>
                        <td className="py-3 px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                >
                  {action.isPending ? "Processing..." : "Create Hedge"}
                </Button>
                <Button
                  className="w-full"
                  variant="outline"
