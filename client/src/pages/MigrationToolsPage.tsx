...
export default function MigrationToolsPage() {
  ...
  const statsQuery = trpc.systemMigrationTools.getStats.useQuery();
      ...
      <div className="space-y-6 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Database schema migrations, data export/import
            </p>
          </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Migration Tools Dashboard</CardTitle>
                <CardDescription>
          ...
          <TabsContent value="settings">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    Configure Migration Tools settings and preferences.
                  </p>
                  <Button
                    variant="outline"
