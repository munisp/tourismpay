...
export const config = {
  ...
  AUTH_ISSUER: process.env.GDS_AUTH_ISSUER || "http://localhost:8180/realms/gds",
  AUTH_AUDIENCE: process.env.GDS_AUTH_AUDIENCE || "gds-api",
  AUTH_JWKS_URI: process.env.GDS_AUTH_JWKS_URI || "http://localhost:8180/realms/gds/protocol/openid-connect/certs",
