...
/// Mirrors the React Native AccountVerificationScreen for cross-platform parity.
...
class _AccountVerificationScreenState extends ConsumerState<AccountVerificationScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/account-verification');
                  ...
                  children: [
                    ...
                    Card(
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.person_outlined, size: 32, color: theme.colorScheme.primary),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your account verification settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides account verification functionality. '
