...
/// Under Review Screen
/// Mirrors the React Native UnderReviewScreen for cross-platform parity.
...
class _UnderReviewScreenState extends ConsumerState<UnderReviewScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/under-review');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your under review settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides under review functionality. '
