...
/// Mirrors the React Native DisputeResolutionScreen for cross-platform parity.
...
class _DisputeResolutionScreenState extends ConsumerState<DisputeResolutionScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/dispute-resolution');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your dispute resolution settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides dispute resolution functionality. '
