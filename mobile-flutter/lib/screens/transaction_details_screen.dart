...
/// Mirrors the React Native TransactionDetailsScreen for cross-platform parity.
...
class _TransactionDetailsScreenState extends ConsumerState<TransactionDetailsScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/transaction-details');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your transaction details settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides transaction details functionality. '
