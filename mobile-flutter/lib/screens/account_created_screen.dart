...
/// Mirrors the React Native AccountCreatedScreen for cross-platform parity.
...
class _AccountCreatedScreenState extends ConsumerState<AccountCreatedScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/account-created');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your account created settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides account created functionality. '
