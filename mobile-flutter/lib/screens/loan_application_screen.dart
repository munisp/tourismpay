...
/// Mirrors the React Native LoanApplicationScreen for cross-platform parity.
...
class _LoanApplicationScreenState extends ConsumerState<LoanApplicationScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/loan-application');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your loan application settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides loan application functionality. '
