...
/// Backup Codes Screen
/// Mirrors the React Native BackupCodesScreen for cross-platform parity.
...
class _BackupCodesScreenState extends ConsumerState<BackupCodesScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/backup-codes');
                  ...
                  children: [
                    ...
                    Card(
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.backup_outlined, size: 32, color: theme.colorScheme.primary),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your backup codes settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides backup codes functionality. '
