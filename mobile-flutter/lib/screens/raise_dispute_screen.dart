...
/// Mirrors the React Native RaiseDisputeScreen for cross-platform parity.
...
class _RaiseDisputeScreenState extends ConsumerState<RaiseDisputeScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/raise-dispute');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your raise dispute settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides raise dispute functionality. '
