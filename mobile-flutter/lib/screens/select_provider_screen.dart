...
/// Mirrors the React Native SelectProviderScreen for cross-platform parity.
...
class _SelectProviderScreenState extends ConsumerState<SelectProviderScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/select-provider');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your select provider settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides select provider functionality. '
