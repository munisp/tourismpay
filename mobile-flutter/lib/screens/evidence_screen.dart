...
/// Evidence Screen
/// Mirrors the React Native EvidenceScreen for cross-platform parity.
...
class _EvidenceScreenState extends ConsumerState<EvidenceScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/evidence');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your evidence settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides evidence functionality. '
