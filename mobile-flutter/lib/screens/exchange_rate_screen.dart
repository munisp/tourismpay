...
/// Mirrors the React Native ExchangeRateScreen for cross-platform parity.
...
class _ExchangeRateScreenState extends ConsumerState<ExchangeRateScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/exchange-rate');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your exchange rate settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides exchange rate functionality. '
