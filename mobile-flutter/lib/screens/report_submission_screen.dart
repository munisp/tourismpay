...
/// Mirrors the React Native ReportSubmissionScreen for cross-platform parity.
...
class _ReportSubmissionScreenState extends ConsumerState<ReportSubmissionScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/report-submission');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your report submission settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides report submission functionality. '
