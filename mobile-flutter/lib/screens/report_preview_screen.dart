...
/// Mirrors the React Native ReportPreviewScreen for cross-platform parity.
...
class _ReportPreviewScreenState extends ConsumerState<ReportPreviewScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/report-preview');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your report preview settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides report preview functionality. '
