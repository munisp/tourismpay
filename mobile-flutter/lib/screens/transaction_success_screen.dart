...
/// Mirrors the React Native TransactionSuccessScreen for cross-platform parity.
...
class _TransactionSuccessScreenState extends ConsumerState<TransactionSuccessScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/transaction-success');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your transaction success settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides transaction success functionality. '
