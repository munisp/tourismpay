...
/// Mirrors the React Native BeneficiaryListScreen for cross-platform parity.
...
class _BeneficiaryListScreenState extends ConsumerState<BeneficiaryListScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/beneficiary-list');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your beneficiary list settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides beneficiary list functionality. '
