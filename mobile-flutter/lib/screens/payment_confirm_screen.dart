...
/// Mirrors the React Native PaymentConfirmScreen for cross-platform parity.
...
class _PaymentConfirmScreenState extends ConsumerState<PaymentConfirmScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/payment-confirm');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your payment confirm settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides payment confirm functionality. '
