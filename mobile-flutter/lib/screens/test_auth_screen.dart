...
/// Test Auth Screen
/// Mirrors the React Native TestAuthScreen for cross-platform parity.
...
class _TestAuthScreenState extends ConsumerState<TestAuthScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/test-auth');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your test auth settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides test auth functionality. '
