...
/// Fraud Alert Screen
/// Mirrors the React Native FraudAlertScreen for cross-platform parity.
...
class _FraudAlertScreenState extends ConsumerState<FraudAlertScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/fraud-alert');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your fraud alert settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides fraud alert functionality. '
