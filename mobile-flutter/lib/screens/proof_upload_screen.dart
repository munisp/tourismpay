...
/// Proof Upload Screen
/// Mirrors the React Native ProofUploadScreen for cross-platform parity.
...
class _ProofUploadScreenState extends ConsumerState<ProofUploadScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/proof-upload');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your proof upload settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides proof upload functionality. '
