...
/// Mirrors the React Native RegistrationFormScreen for cross-platform parity.
...
class _RegistrationFormScreenState extends ConsumerState<RegistrationFormScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/registration-form');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your registration form settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides registration form functionality. '
