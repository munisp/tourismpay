...
/// Enter Phone Screen
/// Mirrors the React Native EnterPhoneScreen for cross-platform parity.
...
class _EnterPhoneScreenState extends ConsumerState<EnterPhoneScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/enter-phone');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your enter phone settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides enter phone functionality. '
