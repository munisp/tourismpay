...
/// Topup Amount Screen
/// Mirrors the React Native TopupAmountScreen for cross-platform parity.
...
class _TopupAmountScreenState extends ConsumerState<TopupAmountScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/topup-amount');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your topup amount settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides topup amount functionality. '
