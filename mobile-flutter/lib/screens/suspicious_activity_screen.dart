...
/// Mirrors the React Native SuspiciousActivityScreen for cross-platform parity.
...
class _SuspiciousActivityScreenState extends ConsumerState<SuspiciousActivityScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/suspicious-activity');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your suspicious activity settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides suspicious activity functionality. '
