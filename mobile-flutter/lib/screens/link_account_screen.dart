...
/// Link Account Screen
/// Mirrors the React Native LinkAccountScreen for cross-platform parity.
...
class _LinkAccountScreenState extends ConsumerState<LinkAccountScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/link-account');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your link account settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides link account functionality. '
