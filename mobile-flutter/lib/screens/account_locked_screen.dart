...
/// Mirrors the React Native AccountLockedScreen for cross-platform parity.
...
class _AccountLockedScreenState extends ConsumerState<AccountLockedScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/account-locked');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your account locked settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides account locked functionality. '
