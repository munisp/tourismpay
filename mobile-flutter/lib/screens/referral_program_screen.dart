...
/// Mirrors the React Native ReferralProgramScreen for cross-platform parity.
...
class _ReferralProgramScreenState extends ConsumerState<ReferralProgramScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/referral-program');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your referral program settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides referral program functionality. '
