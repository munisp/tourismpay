...
/// Mirrors the React Native SelectPackageScreen for cross-platform parity.
...
class _SelectPackageScreenState extends ConsumerState<SelectPackageScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/select-package');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your select package settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides select package functionality. '
