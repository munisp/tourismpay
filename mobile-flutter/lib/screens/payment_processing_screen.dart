...
/// Mirrors the React Native PaymentProcessingScreen for cross-platform parity.
...
class _PaymentProcessingScreenState extends ConsumerState<PaymentProcessingScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/payment-processing');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your payment processing settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides payment processing functionality. '
