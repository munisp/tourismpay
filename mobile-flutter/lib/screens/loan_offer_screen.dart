...
/// Loan Offer Screen
/// Mirrors the React Native LoanOfferScreen for cross-platform parity.
...
class _LoanOfferScreenState extends ConsumerState<LoanOfferScreen> {
  ...
  Future<void> _loadData() async {
    final data = await ApiService.instance.get('/loan-offer');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Manage your loan offer settings and data',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'This screen provides loan offer functionality. '
